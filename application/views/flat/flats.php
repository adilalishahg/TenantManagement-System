				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<?php foreach ($flats as $flat) { ?>
							<div class="col-xl-4 col-md-6 mb-4 flat" id='<?php echo "flat_" . $flat['flat_id']; ?>' data-name='<?php if ($flat['type'] == 'A') {
																																	echo "Luxary Flat";
																																} else {
																																	echo "Normal Flat";
																																}  ?>' data-price='<?php echo $flat['rent']; ?>' data-user='<?php print_r($_SESSION['user_id']); ?>'>
									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<div class="h5 mb-0 font-weight-bold text-gray-800"><?php if (isset($flat['status']) && $flat['status'] == '1') {
																										echo 'Available';
																									}  ?></div>
											</div>
											<div class="col-auto">
